        ...
        >
            ...
            >
                <div className="flex items-center justify-between">
                     <h2 className="text-white text-xl font-bold">{type} Token</h2>
                ...
                <div className="flex flex-col gap-2 p-4 rounded-lg bg-[#121212] border border-[#3c3c53]">
                    <div className="flex justify-between items-center">
                        <span className="text-sm text-[#A0A0A0]">You pay</span>
                        <span className="text-sm text-[#A0A0A0]">Balance: 25.4 SOL</span>
                    </div>
                ...
                <div className="flex flex-col gap-2 p-4 rounded-lg bg-[#121212] border border-[#3c3c53]">
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm text-[#A0A0A0]">Balance: 0 WIF</span>
                    </div>
                    <div className="flex justify-between items-center gap-4">
                        <input 
                            type="number"
