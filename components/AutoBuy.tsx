  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        <h1 className="text-white text-4xl font-black leading-tight tracking-[-0.033em]">Auto-Buy Memecoins</h1>
        <p className="text-[#A0A0A0] text-base font-normal leading-normal">Set up and manage your automated memecoin purchasing strategies. <span className="text-red-500/80">Please be aware of the high risks involved.</span></p>
      </div>
